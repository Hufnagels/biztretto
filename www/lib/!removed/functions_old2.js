...
//mymedia & editor
    ...
    $.fn.extend({
        ...
        confirmModal: function (options) {
            ...
            var html = '<div class="modal" id="myModal"><div class="modal-header functionHeader orangeT"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>' +
                '<h3>#Heading#</h3></div><div class="modal-body' + ((options.type == 'question') ? ' question' : '') + '">' +
