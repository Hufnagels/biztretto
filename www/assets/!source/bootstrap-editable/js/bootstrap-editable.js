            ...
            **/
            ...
            .then($.proxy(function () {
                ...
                **/
                ...
                this.showForm();
                if(this.$form.find('[type="password"]').length > 0){
                    this.$form.find('[type="password"]').pwstrength({
                        viewports:
                        {
                            progress: '.editableform',
                            verdict: '.editableform',
                            errors: '.editableform'
                        }
                    });
                }
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.url === 'function') { //user's function
                    ...
                    return $.ajax($.extend({
                        ...
                        data    : params,
                        type    : 'POST'
                    }, this.options.ajaxOptions));/*.done(function(data){
                            console.log(data)
                        });
