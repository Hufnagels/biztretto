...
///////////////////////////////////////
        ...
        var showMenu = function() {
            ...
            var menu = document.createElement('div'),
                ...
                elContainer = document.createElement('ul'),
                el = document.createElement('li');

            // Apply some classes
            menu.className = 'menu';
            el.className = 'menu-item';
            elContainer.className = 'dropdown fade in';
            elContainer.id = 'menuList';
            ...
            arrayify(byId('impress').firstElementChild.children).forEach(
              function( child, index ) {
                var newEl = el.cloneNode(),
                    ...
                    text = i + '. ' + ( 
                    capitalize(child.getAttribute('data-slide-tag')).length > 0 ? capitalize(child.getAttribute('data-slide-tag')) : 'slide '+ i 
                    );//.id);
            ...
            menuButton.addEventListener("click", function(){
              var clName = this.parentNode.className;
              var dd = document.getElementById('menuList');
              console.log(this.firstChild);
              dd.className = clName == "menu" ? 'dropdown fade in': 'dropdown fade';
              this.parentNode.className = clName == "menu" ? "menu open" : "menu";
            });
        };
//////////////////////////////////////////
        ...
        root.addEventListener("impress:init", function(){
            ...
            root.addEventListener("impress:stepleave", function (event) {
                ...
                htmlTree(event.target);
                //console.log( htmlTree(event.target) )
            }, false);
...
//alert(obj.tagName);
  if( obj.tagName == 'IFRAME'){
    var func =  'pauseVideo';
    obj.contentWindow.postMessage('{"event":"command","func":"' + func + '","args":""}', '*');
  } else if(obj.tagName == 'VIDEO'){
    obj.pause();
  } else {
