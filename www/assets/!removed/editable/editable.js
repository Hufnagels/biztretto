...
(function ($) {
    ...
    Editable.prototype = {
        ...
        show: function () {
            ...
            //add header class
            this.$element.find('.popover-title').addClass('functionHeader orangeT');
            //show popover
            ...
            .then($.proxy(function () {
                ...
                if (this.errorOnRender) {
                    ...
                    $tip.find('button.set').attr('disabled', true); //btn-primary
                    ...
                    $tip.find('button.set').removeAttr('disabled'); //btn-primary
                    //bind form submit
    ...
    $.fn.editable.defaults = {
        ...
        formTemplate:'<form class="form-inline" autocomplete="off" action="#">' + 
                       '<div class="control-group">' + 
                       '&nbsp;<button type="submit" class="btn btn-dark set"><i class="icon-ok icon-white"></i></button>&nbsp;<button type="button" class="btn btn-dark editable-cancel"><i class="icon-ban-circle"></i></button>' + 
